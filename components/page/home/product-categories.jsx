  ...
  return (
    <section ref={sectionRef} className="py-8">
      ...
      <div className="w-[95%] mx-auto">
        <h2 ref={headingRef} className="text-4xl text-center font-bold">Product Category</h2>
            ...
            {categories.map((category, index) => (
              <SwiperSlide key={index}>
                <Link 
                  ...
                  className="block"
                >
                  <div className="bg-white rounded-lg p-8 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col items-center justify-center min-h-[280px] relative group">
